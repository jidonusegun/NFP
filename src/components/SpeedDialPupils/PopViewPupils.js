...
import PupilsAccountView from 'views/ViewProfile/PupilsAccountView/PupilsAccountView';
...
export default function PopView({details}) {
  ...
  return (
        <div>
            <DialogView children={<PupilsAccountView details={details} />} title="Profile" />
