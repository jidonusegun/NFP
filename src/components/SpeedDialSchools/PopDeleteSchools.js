...
const response = await deleteContent(`https://nsfp.herokuapp.com/v1/school/${details._id}`, token);
// addCook.reset();
...
//   console.log(body);
  ...
  return (
        <div>
            <DialogDelete title="Delete" children={`Are you sure you want to delete ? ${details.name}`} noButton="No" yesButton="Yes" handleDelete={deletePost.submit} />
