...
import SchoolsAccountView from 'views/ViewProfile/SchoolsAccountView/SchoolsAccountView';
...
export default function PopView({details}) {
  ...
  return (
        <div>
            <DialogView children={<SchoolsAccountView details={details} />} title="Profile" />
